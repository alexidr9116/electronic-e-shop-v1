                ...
                <div className="flex flex-col px-2 justify-center">
                    ...
                    <div className="grid gap-2 grid-cols-2 justify-center mb-4">
                        <div className='flex flex-col'>
                            ...
                            <AmountInput maxValue={Math.max(0, product?.stockAmount)} onChangeValue={onChangeValue} />
                            <label className='text-sm'>Available:{strNumber(Math.max(0,product?.stockAmount))}</label>
                        </div>
                        <div className="flex gap-1">
                            <button className='btn btn-accent text-white btn-sm md:btn-md'
                                onClick={handleCart} disabled={product.stockAmount <= 0}
                            >
