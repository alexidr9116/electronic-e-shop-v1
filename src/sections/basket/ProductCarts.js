                        ...
                        <tbody>
                            {
                                baskets.map((product, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            {strPrice(product?.usdLow * time, currency)}
                                        </td>
                                        <td>
                                            <AmountInput
                                                defaultValue={product.basketAmount}
                                                maxValue={Math.max(0, product.stockAmount)}
                                        ...
                                        <td className="">
                                            {strPrice(product?.usdLow * time * product?.basketAmount, currency)}
                                        </td>
                                        <td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td className='text-lg font-bold text-accent '>
                                    {
                                        strPrice(baskets.reduce((prev, product) => (prev + product.usdLow * time * product.basketAmount), 0), currency)
                                    }
                                </td>
                                <td>
